 ...
 <div class = "containter">
 	<div class="row"> 
 		<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd; margin: 20px">
 			<thead>
 				<tr>
 					<th colspan="3" style="background-color: #eeeeee; text-align: center;">주문 내용</th>
 					
 				</tr>
 			</thead>
 				<tbody>
 					<tr>
 						<td style="width: 20%;">주문 상품</td>
 		...
 		<a href="bbs.jsp" class="btn btn-primary" style = "margin-left : 40px;">목록</a>
 		<%
